      ...
      <div className="lg:col-span-3 space-y-6">
        ...
        >
          <div className="text-center">
            <div className="text-4xl font-light mb-2 text-gray-100">{formatTime(currentTime)}</div>
      ...
      <div className="lg:col-span-6 space-y-6">
        ...
        >
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-3xl font-light mb-2 text-gray-100">{preferences.city}</h2>
                <p className="text-gray-400">{weather.description}</p>
              </div>
              <div className="text-right">
                <div className="text-5xl font-light mb-2 text-gray-100">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            />
            <div className="flex-1">
              <h3 className="font-semibold text-lg text-gray-100">{currentTrack.name}</h3>
  ...
  return (
    <div className="min-h-screen bg-black relative">
      ...
      <div className="relative z-10 p-6 max-w-7xl mx-auto">
        ...
        {/* Navigation Tabs */}
        <div className="mb-8">
          <div className="flex items-center gap-2 bg-gray-900/80 backdrop-blur-xl rounded-2xl p-2 border border-gray-800 w-fit">
            <Button
